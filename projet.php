...
<div class="div-menu">
  <div class="div-menu-button">
     ...
     <a href="projet.php" style="background-color:orangered;color:white;" class="button-menu">PROJETS</a>
  ...
  <div class="div-article">
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">MONTAGE ELECTRONIQUE</span>
      </div>
      ...
      <div class="div-text-projet">
        ...
        <center>
          <a href="#login_form" id="login_pop"><button class="button-bloc">Int&eacute;resser par le projet</button></a>
        </center>
      </div>
    </div>
    <br>
  ...
  <div class="div-article-right">
    ...
    <center>
      <div class="div-liste-article">
        <span class="titre-bloc-article">LES PROJETS</span>
      </div>
    </center>
    <div class="liste-right-article">
      <br>
      <li class="liste-article">Electronique</li>
      <li class="liste-article">Mecanique</li>
      <li class="liste-article">Developpement</li>
      <li class="liste-article">Montage</li>
      <li class="liste-article">Mecanique</li>
      <li class="liste-article">Developpement</li>
      <li class="liste-article">Electronique</li>
    </div>
