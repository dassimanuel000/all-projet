...
<div class="div-menu">
  <div class="div-menu-button">
     ...
     <a href="actu.php" style="background-color:orangered;color:white;" class="button-menu">ACTUALITES</a>
  ...
  <div class="div-article">
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">OLYMPIADES</span>
      </div>
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">BUREAU DE LA PROMOM</span>
      </div>
      <div class="div-date-projet">
        <span class="date-projet">Fait le 12 Octobre 2019 a 12h 35 min</span>
      </div>
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">PROJETS COMMUNAUTAIRES</span>
      </div>
      <div class="div-date-projet">
        <span class="date-projet">Fait le 12 Octobre 2019 a 12h 35 min</span>
      </div>
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">Developpement</span>
      </div>
      <div class="div-date-projet">
        <span class="date-projet">Fait le 12 Octobre 2019 a 12h 35 min</span>
      </div>
          ...
          <a href="#login_form" id="login_pop"><button class="button-bloc">Int&eacute;resse&eacute;(e)</button></a>
      	       ...
      	       <!-- <div class="main">
      	            ...
      	            <div class="panel">
      	                ...
      	                <a href="#join_form" id="join_pop">Contactez</a>
  ...
  <div class="div-article-right">
    ...
    <center>
      <div class="div-liste-article">
        <span class="titre-bloc-article">LES NEWS</span>
      </div>
    </center>
    <div class="liste-right-article">
      <br>
      <li class="liste-article">Projet</li>
      <li class="liste-article">Promotion</li>
      <li class="liste-article">Developpement</li>
      <li class="liste-article">Sortie</li>
      <li class="liste-article">Mecanique</li>
      <li class="liste-article">Innovations</li>
