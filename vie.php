...
<div class="div-menu">
  <div class="div-menu-button">
     ...
     <a href="projet.php" style="" class="button-menu">PROJETS</a>
     <a href="vie.php" style="background-color:orangered;color:white;" class="button-menu">VIE ASSOCIATIVE</a>
  ...
  <div class="div-article">
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">OLYMPIADES SPORTIVES</span>
      </div>
      ...
      <div class="div-text-projet">
        ...
        <center>
          <a href="#login_form" id="login_pop"><button class="button-bloc">Plus d'informations</button></a>
        </center>
      </div>
    </div>
    <br>
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">JOURNEE COMMUNAUTAIRE</span>
      </div>
      <div class="div-date-projet">
        <span class="date-projet">Fait le 12 Octobre 2019 a 12h 35 min</span>
      </div>
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">SORTIE EDUCATIVE</span>
      </div>
      <div class="div-date-projet">
        <span class="date-projet">Fait le 12 Octobre 2019 a 12h 35 min</span>
      </div>
    ...
    <div class="div-contain-article">
      <div class="div-titre-projet">
        <span class="titre-projet">SOIREE DETENTE</span>
      </div>
      <div class="div-date-projet">
        <span class="date-projet">Fait le 12 Octobre 2019 a 12h 35 min</span>
      </div>
  ...
  <div class="div-article-right">
    ...
    <center>
      <div class="div-liste-article">
        <span class="titre-bloc-article">LES ACTIVITES</span>
      </div>
    </center>
    <div class="liste-right-article">
      <br>
      <li class="liste-article">Sortie</li>
      <li class="liste-article">Olympiades</li>
      <li class="liste-article">Developpement</li>
      <li class="liste-article">Soiree</li>
      <li class="liste-article">Quiz</li>
